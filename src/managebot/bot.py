...
from managebot.handlers.start_menu import start_menu_handler, button_click_handler
...
# 按钮点击时触发
app.add_handler(CallbackQueryHandler(button_click_handler, pattern="^btn[1-9]$"))
